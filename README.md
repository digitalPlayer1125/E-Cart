# E-Cart  ![logo](https://img.icons8.com/dusk/2x/java-coffee-cup-logo.png)
...
|------------------------|-----------------------------------------------|
|[./home.java]                  |* The Code *|
|[./Test]                       |* The Tests * - folder that consists of the test files. |
...
2. Clone your fork:
    ...
    `git clone https://github.com/<username>/E-Cart.git`
    
    Where `<username>` is your github username.

3. Add the base repository as a remote:
    
    `git remote add upstream https://github.com/digitalPlayer1125/E-Cart.git`
